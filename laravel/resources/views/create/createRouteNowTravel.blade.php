...
<!--タイトル-->
@section('title')
now Travel route set
@endsection

<!--追加メタ情報-->
@section('meta')
    <link href="{{ asset('css/createRouteNowTravel.css') }}" rel="stylesheet">
...
@section('contents')
    ...
    <div class="wrapper">
        ...
        <div class="configContainer">
            <div class="sectorA">
                <div class="titleSection"><div class="title">作成開始！</div></div>
                <div class="configSection">
                <form method="POST" id="nextActionA" action="{{ route('makeRouteNowTravel') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="itemSection">
                        <!-- 名前 -->
                        <div class="singleText">
                            <div class="name">名前をつけよう（※必須）</div>
                            <div class="content"><input type="text" name="name" class="text" placeholder="〇〇旅行１日目等">{{ old('name') }}</div>
                        </div>
                        <!-- エラーメッセージ -->
                        ...
                        <!-- 紹介メッセージ -->
                        <div class="multiText">
                            <div class="name">目的は何？（※必須）</div>
                            <div class="content"><textarea name="text" class="text" placeholder="〇〇を見に行く等">{{ old('text') }}</textarea></div>
                        </div>
                        <!-- エラーメッセージ -->
